            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6 align-items-center d-flex pb-md-5 pt-5 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="500" data-aos-duration="500">
                    <div class="card w-100 border-0 shadow-lg bg-white p-4 p-md--5">
                        <h2 class="fw-700 text-grey-900 display2-size display2-md-size lh-1 mb-3 mt-0">Login </h2>

                        <div class="form-group mt-0 p-2 mb-0 bg-white rounded-lg">
                            <div class="row">
                                <div class="col-lg-12">
                                    <!-- <input type="input" class="style2-input pl-5 form-control text-grey-900 font-xssss ls-3" placeholder="Search online courses.."> -->
                                    <div class="form-group icon-input mb-4">
                                        <i class="ti-mobile font-xs text-grey-400"></i>
                                        <input type="tel" maxlength="10" class="style2-input pl-5  w-100 font-xsss mb-0 text-grey-500 fw-500" placeholder="Mobile Number">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <!-- <input type="input" class="style2-input pl-5 form-control text-grey-900 font-xssss ls-3" placeholder="Search online courses.."> -->
                                    <div class="form-group icon-input mb-4">
                                        ...
                                        <input type="password" maxlength="4" class="style2-input pl-5  w-100 font-xsss mb-0 text-grey-500 fw-500" placeholder="OTP">
                                    </div>
                                </div>

                                <div class="col-lg-12">
                                    <a href="#" class="w-100 d-block btn bg-current text-white font-xssss fw-600 ls-3 style1-input p-0 border-0 text-uppercase ">Login</a>
                                </div>
            ...
            <div class="row justify-content-center">
                <div class="page-title style1 col-xl-6 col-lg-6 col-md-10 text-center mb-5">
                    ...
                    <ul class="nav nav-tabs tabs-icon list-inline d-block w-100 text-center border-bottom-0 mt-4" id="myNavTabs">
                        <li class="active list-inline-item"><a class="fw-700 ls-3 font-xssss text-black text-uppercase ml-3 active" href="#navtabs1" data-toggle="tab">PSC</a></li>
                        <li class="list-inline-item"><a class="fw-700 ls-3 font-xssss text-black text-uppercase ml-3" href="#navtabs2" data-toggle="tab">UPSE</a></li>
                        <li class="list-inline-item"><a class="fw-700 ls-3 font-xssss text-black text-uppercase ml-3" href="#navtabs2" data-toggle="tab">GATE</a></li>
                        <li class="list-inline-item"><a class="fw-700 ls-3 font-xssss text-black text-uppercase ml-3" href="#navtabs1" data-toggle="tab">IFS</a></li>
                ...
                <div class="tab-pane fade show active" id="navtabs1">
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1">
                                <div class="card-image w-100 mb-3">
                                    <a href="{{url('packages/1')}}" class="video-bttn position-relative d-block"><img src="{{ asset('web/images/v-4.jpeg') }}" alt="image" class="w-100"></a>
                                </div>
                                <div class="card-body pt-0">
                                    ...
                                    <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="{{url('packages/1')}}" class="text-dark text-grey-900">The Data Science Course Complete Data Science </a></h4>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1">
                                <div class="card-image w-100 mb-3">
                                    <a href="{{url('packages/1')}}" class="video-bttn position-relative d-block"><img src="{{ asset('web/images/v-2.png') }}" alt="image" class="w-100"></a>
                                </div>
                                <div class="card-body pt-0">
                                    ...
                                    <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="{{url('packages/1')}}" class="text-dark text-grey-900">Complete Python Bootcamp From Zero to Hero in Python </a></h4>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1">
                                <div class="card-image w-100 mb-3">
                                    <a href="{{url('packages/1')}}" class="video-bttn position-relative d-block"><img src="{{ asset('web/images/v-3.png') }}" alt="image" class="w-100"></a>
                                </div>
                                <div class="card-body pt-0">
                                    ...
                                    <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="{{url('packages/1')}}" class="text-dark text-grey-900">Fundamentals for Scrum Master and Agile Projects </a></h4>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1">
                                <div class="card-image w-100 mb-3">
                                    <a href="{{url('packages/1')}}" class="video-bttn position-relative d-block"><img src="{{ asset('web/images/v-1.png') }}" alt="image" class="w-100"></a>
                                </div>
                                <div class="card-body pt-0">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="{{url('packages/1')}}" class="text-dark text-grey-900">Java Programming Masterclass for Developers</a></h4>
                ...
                <div class="tab-pane fade" id="navtabs2">
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1">
                                <div class="card-image w-100 mb-3">
                                    <a href="{{url('packages/1')}}" class="video-bttn position-relative d-block"><img src="https://via.placeholder.com/400x300.png" alt="image" class="w-100"></a>
                                </div>
                                <div class="card-body pt-0">
