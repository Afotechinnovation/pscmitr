...
@section('header')
    ...
    @can('create', \App\Models\Section::class)
        <div class="page-header-actions">
            <a class="btn btn-sm btn-primary btn-round" href="{{ route('admin.sections.create') }}">
...
@section('content')
    <div class="card">
        <div class="card-body bg-grey-100">
            <form id="form-filter-sections" class="form-inline mb-0" id="form-filter">
        ...
        <div class="card-body">
            {!! $table->table(['id' => 'table-sections'], true) !!}
        </div>
    </div>
@endsection
...
@push('scripts')
    <script>
        $(function() {
            ...
            $('#table-sections').on('preXhr.dt', function (e, settings, data) {
                data.filter = {
                    search: $('#search').val()
                };
            });
            ...
            $('#form-filter-sections').submit(function(e) {
                e.preventDefault();
