...
@section('header')
    <h1 class="page-title mb-2">Create Package</h1>
...
@section('content')
    <div class="panel">
        <form id="form-create-package" method="POST" action="{{ route('admin.packages.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-7 col-lg-7">
                            ...
                            <div class="col-md-8">
                                <select name="package_highlights[]" id="package_highlights" multiple class="form-control
                                    ...
                                    @foreach($highlights as $highlight)
                                        <option @if (old("package_highlights"))
                                                    {{ (in_array($highlight->id, old("package_highlights")) ? "selected":"") }}
                                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="display_name" name="display_name" type="text" required
                                       ...
                                       placeholder="Package's display name" value="{{ old('display_name') }}"
                                       autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input  class="form-control @error('cover_pic') is-invalid @enderror" type="file"
                                        ...
                                        id="cover_pic" name="cover_pic"  required >
                                @error('cover_pic')
                                <span class="invalid-feedback" role="alert" style="display: inline;">
                            ...
                            <div class="col-md-8">
                                <div class="input-group mb-3">
                                    <input id="expire_on" name="expire_on" type="number" min="0" required
                                           ...
                                           placeholder="Expire In" value="{{ old('expire_on') }}"
                                           autocomplete="off">
                                    <div class="input-group-append">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                  <textarea name="description" required placeholder="Description" class="form-control @error('description') is-invalid @enderror"
...
@push('scripts')
    <script>
        ...
        $(function() {
            ...
            $('input[name="visibility"]').daterangepicker({
                minDate:new Date(),
                format: 'YYYY-MM-DD',
            });
            ...
            let package_requirements = @json( old('requirements') );
            let requirements_data = JSON.parse(package_requirements);

            const requirements = new EditorJS({
                holder : 'editorRequirementId',
                placeholder: 'Requirements',
                data : requirements_data ? requirements_data : ''

            });

            let package_contents = @json( old('package_content') );
            ...
            const package_content = new EditorJS({
                ...
                data : package_content_data ? package_content_data : ''
            });
            ...
            $('#form-create-package').on('submit', function () {

                if ($('#form-create-package').valid()) {
