@can('update', $category)
    <a href="{{ route('admin.test-categories.edit', $category->id) }}" class="btn btn-sm btn-icon btn-pure btn-default ladda-button
...
@endcan
@can('delete', $category)
    <a href="{{ route('admin.test-categories.destroy', $category->id) }}"
