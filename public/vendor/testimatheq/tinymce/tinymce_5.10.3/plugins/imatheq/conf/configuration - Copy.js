 ...
 */
var _imatheq_conf_save_image_api = "//www.testing.com/imatheq/com/imatheq/default.aspx";
//var _imatheq_conf_save_image_api = "//www.testing.com/customer_code/save_imatheq_eq_image.aspx";

/*
 * The URL of saved image and the type of URL
 *	Type = "image_path", the _imatheq_conf_image_url is like, "//www.testing.com/images/"
 *		   the eventual url will be like "//www.testing.com/images/[GUID].png?iMathEQ_qid=[GUID]"
 *	Type = "api", the _imatheq_conf_image_url is like, "//www.testing.com/saveimage.aspx"
 *		   the eventual url will be like "//www.testing.com/saveimage.aspx?iMathEQ_qid=[GUID]"
 *	Parameter: iMathEQ_qid - used to retrieve equation image
 */
//default value
var _imatheq_conf_image_url = "//www.testing.com/imatheq/images/"; //only for server license
var _imatheq_conf_image_url_type = "image_path"	//"image_path" or "api"
//customer values
//var _imatheq_conf_image_url = "//www.testing.com/customer_code/get_imatheq_eq_image.aspx";
//var _imatheq_conf_image_url_type = "api"	//"image_path" or "api"

/*
 * This variable is reservered for system used. Must set it as true 
 */
_imatheq_conf_loaded = true;
